...
const App = () => {
  ...
  const [aiMessages, setAiMessages] = useState([
    { type: 'bot', text: '¡Hola! Soy Sigma AI Beta. ¿En qué puedo ayudarte?' }
  ]);
  ...
  const products = [
    {
      ...
      description: 'Plataforma web de gaming con +100 juegos para PC sin descargas. Juegos entretenidos de GitHub con copyright, accesibles desde cualquier navegador.',
      features: [
        'Más de 100 juegos disponibles',
        'Sin descargas necesarias',
        'Juegos de GitHub con copyright',
    ...
    },
    {
      ...
      description: 'Plataforma de inteligencia artificial avanzada que revolucionará la productividad. Asistente inteligente con capacidades de comprensión contextual.',
      features: [
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex items-center justify-center z-50">
        <div className="text-center">
          ...
          <p className="text-gray-300 mt-4 animate-fade-in-up delay-500">
            Cargando experiencia innovadora...
          </p>
        </div>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <p className={`text-xl md:text-2xl mb-8 max-w-3xl mx-auto animate-fade-in-up delay-300 ${
              ...
              Desarrollamos aplicaciones innovadoras que transforman la experiencia digital. 
              Desde gaming web hasta inteligencia artificial avanzada.
            </p>
      ...
      <section className={`py-20 ${darkMode ? 'bg-gray-800/50' : 'bg-white/50'} backdrop-blur-sm`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { icon: <Users className="w-8 h-8" />, number: '10K+', label: 'Usuarios Activos' },
              { icon: <Gamepad2 className="w-8 h-8" />, number: '100+', label: 'Juegos Disponibles' },
              { icon: <Trophy className="w-8 h-8" />, number: '4.8★', label: 'Calificación' },
              { icon: <Rocket className="w-8 h-8" />, number: '2', label: 'Productos Activos' }
            ].map((stat, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className={`text-xl max-w-3xl mx-auto ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
              Innovación y tecnología de vanguardia en cada desarrollo
            </p>
          </div>
      ...
      <section className={`py-20 ${darkMode ? 'bg-gray-800/30' : 'bg-gray-50/50'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              { icon: <Code className="w-8 h-8" />, name: 'React & TypeScript', color: 'from-blue-500 to-cyan-500' },
              { icon: <Smartphone className="w-8 h-8" />, name: 'Mobile Development', color: 'from-green-500 to-emerald-500' },
              { icon: <Brain className="w-8 h-8" />, name: 'AI & Machine Learning', color: 'from-purple-500 to-pink-500' },
              { icon: <Cloud className="w-8 h-8" />, name: 'Cloud Computing', color: 'from-orange-500 to-red-500' }
            ].map((tech, index) => (
              <div
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className={`mb-4 ${darkMode ? 'text-gray-400' : 'text-gray-600'}`}>
              Desarrollando el futuro, una aplicación a la vez.
            </p>
            <p className={`text-sm ${darkMode ? 'text-gray-500' : 'text-gray-500'}`}>
              © 2024 Sigma Company. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </footer>
            ...
            {selectedProduct.id === 'sigmagames' && (
              <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-blue-500 rounded-2xl flex items-center justify-center">
                <button 
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-purple-500 to-blue-500 text-white rounded-xl font-semibold hover:from-purple-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center space-x-2"
                >
                  <Play className="w-5 h-5" />
                  <span>Ir a SigmaGames</span>
                </button>
              </div>
            )}
            ...
            {selectedProduct.id === 'sigmaai' && (
              <div className={`p-4 rounded-xl mb-6 ${
                ...
                <p className={`${darkMode ? 'text-blue-300' : 'text-blue-700'}`}>
                  Sigma AI estará disponible en {selectedProduct.launchDate}
                </p>
              </div>
            )}
          </div>
                ...
                <div className="bg-gradient-to-r from-purple-500 to-blue-500 p-4 flex items-center justify-between">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-purple-100">Asistente IA</p>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    <button
